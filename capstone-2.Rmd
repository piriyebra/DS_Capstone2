...
Almost all records within the train set have a quality of 5 or 6. In this set of data, quality goes from 3 to 8.
...
The fist model to try is Generalized Linear Model (GLM) by using all 11 variables in the data set. 
...
16147 Genoa, Italy. https://archive.ics.uci.edu/ml/index.php
